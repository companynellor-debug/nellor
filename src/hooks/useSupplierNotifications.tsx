...
export const useSupplierNotifications = () => {
  ...
  useEffect(() => {
    ...
    const setupRealtimeSubscription = async () => {
      ...
      console.log('🔌 Setting up realtime subscription for supplier (display only):', userId);

      // Subscribe to notifications table changes
      // ONLY updates local state - NO PUSH NOTIFICATIONS (backend handles push)
      const notificationsChannelName = `notifications-supplier-display-${userId}`;
      notificationsChannel = supabase
        ...
        .on(
          ...
          (payload) => {
            ...
            console.log('🔔 New notification received (display only):', newNotif.title);
            ...
            // Toast in-app ONLY (no push - backend handles push)
            toast({
