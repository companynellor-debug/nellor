...
const AdminSidebar = ({ onNavigate }: AdminSidebarProps) => {
  ...
  return (
    <aside className="w-full h-full flex flex-col bg-gradient-to-b from-purple-950 to-violet-950 text-white lg:w-64 lg:h-screen lg:fixed lg:left-0 lg:top-0 lg:shadow-2xl lg:border-r border-purple-800/30">
