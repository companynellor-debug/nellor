...
const TOUR_STEPS: TourStep[] = [
  {
    ...
    description: "Vamos te guiar pelos primeiros passos para deixar sua loja pronta para vender. Isso leva menos de 5 minutos.",
    isModal: true,
    icon: Sparkles,
  },
  {
    id: 2,
    title: "Seu Dashboard",
    description: "Aqui é o seu Dashboard. Você acompanha suas vendas, pedidos e desempenho em tempo real.",
