  ...
  return <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-gradient-to-br from-primary via-secondary to-accent">
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center bg-indigo-900">
            <div className="text-white space-y-8 animate-slide-in">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link to="/download">
                  <Button size="lg" className="w-full sm:w-auto text-lg px-8 py-6 text-slate-50 bg-purple-700 hover:bg-purple-600">
                    Baixar o App
                  </Button>
                </Link>
                <Link to="/fornecedor">
                  <Button size="lg" variant="outline" className="w-full sm:w-auto border-2 border-white text-white hover:text-primary text-lg px-8 py-6 bg-purple-700 hover:bg-purple-600">
                    Sou fornecedor
                  </Button>
                </Link>
              </div>
            ...
            <div className="relative animate-fade-in">
              <div className="relative z-10 mx-auto max-w-sm">
                <img src="https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?w=400&h=800&fit=crop" alt="App mockup" className="w-full h-auto drop-shadow-2xl rounded-3xl" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {benefits.map((benefit, index) => <Card key={index} className="p-6 shadow-card hover:shadow-hover transition-smooth text-center">
        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {steps.map((step, index) => <div key={index} className="text-center relative">
                ...
                {index < steps.length - 1 && <div className="hidden md:block absolute top-10 left-[60%] w-[80%] h-0.5 bg-primary/30"></div>}
              </div>)}
          </div>
      ...
      <section className="py-20 bg-primary text-white">
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {testimonials.map((testimonial, index) => <Card key={index} className="p-6 bg-white text-foreground">
