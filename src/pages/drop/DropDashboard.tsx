    ...
    <div className="w-full max-w-full space-y-4 md:space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-slate-400 mt-1">Visão geral do seu desempenho no Drop</p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
        <Card className="relative overflow-hidden group hover:shadow-xl transition-all duration-300 bg-slate-900 border-slate-800">
          ...
          <CardContent className="p-4 pt-0">
            <div className="text-2xl font-bold text-white">R$ {totalSales.toFixed(2)}</div>
          </CardContent>
        </Card>
        ...
        <Card className="relative overflow-hidden group hover:shadow-xl transition-all duration-300 bg-slate-900 border-slate-800">
          ...
          <CardContent className="p-4 pt-0">
            ...
            <p className="text-xs text-slate-500 mt-1">Após custos e taxas</p>
          </CardContent>
        </Card>
        ...
        <Card className="relative overflow-hidden group hover:shadow-xl transition-all duration-300 bg-slate-900 border-slate-800">
          ...
          <CardContent className="p-4 pt-0">
            <div className="text-2xl font-bold text-violet-400">{avgCommission.toFixed(1)}%</div>
            <p className="text-xs text-slate-500 mt-1">Sua margem de lucro</p>
          </CardContent>
        </Card>
      ...
      <div className="grid lg:grid-cols-3 gap-6">
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-slate-400 text-sm mt-1">Últimos 6 meses</p>
              </div>
        ...
        <Card className="bg-slate-900 border-slate-800">
          <CardHeader>
            <div className="flex items-center justify-between">
              <CardTitle className="text-white">Por Marketplace</CardTitle>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-slate-400 text-sm mt-1">Últimas vendas do seu catálogo</p>
            </div>
            <Button 
              variant="ghost" 
              size="sm"
          ...
          {recentOrders.length === 0 ? (
            ...
            <div className="divide-y divide-slate-800">
              {recentOrders.map((order: any) => {
                ...
                return (
                  <div key={order.id} className="py-4 first:pt-0 last:pb-0 hover:bg-slate-800/50 transition-colors -mx-4 px-4">
                    <div className="flex items-center justify-between gap-4">
                      <div className="flex items-center gap-4 min-w-0">
                        <div className="h-12 w-12 rounded-xl bg-slate-800 flex items-center justify-center overflow-hidden flex-shrink-0 border border-slate-700">
