...
const Login = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (isSignup) sessionStorage.setItem("nellor_just_signed_up", "1");
          ...
          <div className="max-w-md w-full mx-auto">
            ...
            <form onSubmit={handleSubmit} className="mt-8 space-y-5">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <UserIcon className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" />
                  <Input type="email" placeholder="Digite seu e-mail ou usuário" value={formData.email}
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <Input type={showPassword ? "text" : "password"} placeholder="Digite sua senha"
                    ...
                    autoComplete={isSignup ? "new-password" : "current-password"} data-1p-ignore />
      ...
      <Dialog open={showAdminDialog} onOpenChange={setShowAdminDialog}>
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4">
            ...
            <Button onClick={handleAdminLogin} className="w-full">Acessar Painel Admin</Button>
          </div>
        </DialogContent>
      </Dialog>
...
const Feature = ({ icon: Icon, title, sub }: { icon: typeof Users; title: string; sub: string }) => (
