  ...
  return <div className="min-h-screen flex flex-col relative overflow-hidden">
      ...
      <div className="relative px-6 pb-12 pt-8">
        ...
        <div className="max-w-sm mx-auto space-y-3">
          <Button onClick={() => navigate('/auth?modo=login')} className="w-full h-12 text-white font-medium text-base rounded-xl shadow-sm transition-all duration-200 bg-primary my-[54px]">
            Entrar
          </Button>
